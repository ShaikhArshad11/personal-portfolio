...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const phone = "917083095916"; // <-- YOUR WHATSAPP NUMBER (No +, No spaces)
...
Message: ${message}`;
  ...
  return (
    <div className="kura_tm_section bg-white" id="contact">
      <div className="kura_tm_contact bg-white">
                ...
                <ul>
                  ...
                  <li>
                    <div className="list_inner">
                      ...
                      <span>shaikh121arshad@gmail.com</span>
                    </div>
                  </li>
                  {/* <li>
                    <div className="list_inner">
              ...
              <div className="fields">
                <form onSubmit={handleSubmit} className="contact_form">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <input
                      className="w-full px-4 py-2 border border-gray-500 bg-transparent !rounded-xl"
                      id="name"
                      name="name"
                      type="text"
                      placeholder="Name"
                  ...
                  <div className="mt-4 sm:mt-5">
                    <textarea
                      className="w-full px-4 py-3 border border-gray-200 bg-transparent !rounded-xl min-h-[140px]"
                      id="message"
                      name="message"
                      placeholder="Message"
                    />
                  ...
                  <button
                    type="submit"
                    className="kura_tm_button d-flex align-items-center w-full justify-content-center border py-2 px-3 rounded-xl border-[#ff4522] mt-4 sm:mt-5 w-auto"
                  >
                    <span className="mr-2">Submit</span>
                    <img src="/img/svg/right-arrow.svg" className="svg" alt="" />
                  </button>
